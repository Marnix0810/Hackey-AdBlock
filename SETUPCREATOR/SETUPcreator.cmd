...
REM create setup.
call "%~dp0Assets\Winrar\Winrar.exe" a -r -sfx -iimg"%~dp0logos\hackeylogo.bmp" -iico"%~dp0logos\hackeylogo.ico -z"%~dp0files-for-setup\xfs.conf" * "%userprofile%\OneDrive\Documenten\Programmeren\Programmaprojecten\4. Stable-active\The Hackey-AdBlock project\Setups\Hackeyblocksetup-%vernumb%.exe"
