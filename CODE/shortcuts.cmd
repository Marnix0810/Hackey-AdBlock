...
powershell "$s=(New-Object -COM WScript.Shell).CreateShortcut('%appdata%\Microsoft\Windows\Start Menu\Programs\Hackey AdBlock by Marnix 0810\Request changes in HackeyBlock-lists.url');$s.TargetPath='https://marnix0810.wordpress.com/marnix0810s-hackey-adblock/hackeyblock-contact-form/report-domain/';$s.Save()"
...
powershell "$s=(New-Object -COM WScript.Shell).CreateShortcut('%appdata%\Microsoft\Windows\Start Menu\Programs\Startup\Hackey-AdBlock@startup.lnk');$s.TargetPath='%~dp0hackeyrunner-startup.cmd';$s.Save()"
