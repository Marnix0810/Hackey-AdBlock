...
powershell "$s=(New-Object -COM WScript.Shell).CreateShortcut('%appdata%\Microsoft\Windows\Start Menu\Programs\HackeyBlock by Marnix 0810\Go to HackeyBlock contact form.url');$s.TargetPath='https://marnix0810.wordpress.com/hackey/Hackeyblock-contact-form/';$s.Save()"
powershell "$s=(New-Object -COM WScript.Shell).CreateShortcut('%appdata%\Microsoft\Windows\Start Menu\Programs\HackeyBlock by Marnix 0810\Request changes in HackeyBlock-lists.url');$s.TargetPath='https://marnix0810.wordpress.com/hackey/Hackeyblock-contact-form/report-domain/';$s.Save()"
