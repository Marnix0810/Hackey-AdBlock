...
call powershell -command "iwr -outf latest-version.txt https://raw.githubusercontent.com/Marnix0810/HackeyBlock-Python/master/latest-release.txt"
...
call powershell -command "iwr -outf latest-version.txt https://raw.githubusercontent.com/Marnix0810/HackeyBlock-Python/master/latest-release.txt"
set /p "latestver="<"latest-version.txt"
set updurl=https://github.com/Marnix0810/HackeyBlock-Python/releases/download/v%latestver%/Hackeyblocksetup-%latestver%.exe
if "%locman%"=="1" (
cls
echo locating installer for HackeyBlock using alternative download system.
call powershell -command "iwr -outf updurl.txt https://raw.githubusercontent.com/Marnix0810/HackeyBlock-Python/master/updurl.txt"
