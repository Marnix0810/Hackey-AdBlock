...
call powershell -window maximize -command ""
echo Python is not installed. Press a key to go to https://python.org/ to install the latest version of Python before you continue.
PAUSE >NUL
cls
echo Python is not installed. Go to https://python.org/ to install the latest version of Python before you continue.
...
if not "%hackey-zone-on-or-off%"=="off" type "%~dp0hackey-zonelist.txt" >> "%temp%\hosts.edit.tmp"
cd /d "%~dp0"
